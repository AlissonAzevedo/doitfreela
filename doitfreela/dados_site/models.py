...
class Ferramenta(models.Model):
  requisitos = models.OneToOneField(Requisitos, on_delete=models.CASCADE, null= True)
  documentacao = models.OneToOneField(Documentacao, on_delete=models.CASCADE, null= True)
  tempo = models.OneToOneField(Tempo, on_delete=models.CASCADE, null= True)
